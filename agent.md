...
- Prefer readable dense views over generic render dumps: semantic JSON labels, compact tree indentation, open Text/Table groups, and stable table row headers.
