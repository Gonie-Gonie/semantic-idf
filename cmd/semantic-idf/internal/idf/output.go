...
func outputRecommendations(doc Document, existing []OutputObjectSummary) []OutputRecommendation {
	base := []OutputRecommendation{
		...
		standardOutputMeterRecommendation("standard-meter-propane-facility", "Standard: facility propane", "Propane:Facility", "facility_energy", "Monthly whole-facility propane use."),
		standardOutputMeterRecommendation("standard-meter-other-fuel-1-facility", "Standard: facility other fuel 1", "OtherFuel1:Facility", "facility_energy", "Monthly whole-facility other fuel 1 use."),
		standardOutputMeterRecommendation("standard-meter-other-fuel-2-facility", "Standard: facility other fuel 2", "OtherFuel2:Facility", "facility_energy", "Monthly whole-facility other fuel 2 use."),
		standardOutputMeterRecommendation("standard-meter-steam-facility", "Standard: facility steam", "Steam:Facility", "facility_energy", "Monthly whole-facility steam use."),
		...
		standardOutputMeterRecommendation("standard-meter-electricity-heat-recovery", "Standard: electricity heat recovery", "Electricity:HeatRecovery", "end_use_energy", "Monthly electricity used by heat recovery equipment."),
		...
		standardOutputMeterRecommendation("standard-meter-electricity-exterior-lights", "Standard: electricity exterior lights", "Electricity:ExteriorLights", "end_use_energy", "Monthly electricity used by exterior lights."),
		standardOutputMeterRecommendation("standard-meter-electricity-refrigeration", "Standard: electricity refrigeration", "Electricity:Refrigeration", "end_use_energy", "Monthly electricity used by refrigeration equipment."),
		standardOutputMeterRecommendation("standard-meter-electricity-purchased-facility", "Standard: purchased electricity", "ElectricityPurchased:Facility", "supply_context", "Monthly electricity purchased from the grid."),
		standardOutputMeterRecommendation("standard-meter-electricity-produced-facility", "Standard: onsite electricity production", "ElectricityProduced:Facility", "end_use_energy", "Monthly onsite electricity production."),
		standardOutputMeterRecommendation("standard-meter-electricity-surplus-sold-facility", "Standard: surplus electricity sold", "ElectricitySurplusSold:Facility", "supply_context", "Monthly surplus electricity exported to the grid."),
		...
		standardOutputMeterRecommendation("standard-meter-district-heating-water-interior-equipment", "Standard: district heating water interior equipment", "InteriorEquipment:DistrictHeatingWater", "end_use_energy", "Monthly district heating water consumed by HotWaterEquipment internal gains, not HVAC heating."),
		standardOutputMeterRecommendation("standard-meter-district-heating-interior-equipment", "Standard: legacy district heating interior equipment", "InteriorEquipment:DistrictHeating", "end_use_energy", "Legacy EnergyPlus meter name for monthly district heating consumed by HotWaterEquipment internal gains."),
...
func outputVariablePurposeTags(variableName string, tags map[string]bool) {
	...
	case "zone ideal loads zone sensible cooling energy", "zone ideal loads supply air total cooling energy",
		...
		"zone ideal loads supply air latent heating energy", "zone ideal loads supply air latent heating rate",
		...
		"zone ideal loads supply air latent cooling energy", "zone ideal loads supply air latent cooling rate",
		"zone ideal loads zone latent cooling energy", "zone ideal loads zone latent cooling rate",
		"zone ideal loads outdoor air latent cooling energy", "zone ideal loads outdoor air latent cooling rate",
		"zone ideal loads outdoor air sensible heating energy", "zone ideal loads outdoor air sensible heating rate",
		"zone ideal loads outdoor air total heating energy", "zone ideal loads outdoor air total heating rate",
		"zone ideal loads outdoor air sensible cooling energy", "zone ideal loads outdoor air sensible cooling rate",
		"zone ideal loads outdoor air total cooling energy", "zone ideal loads outdoor air total cooling rate",
