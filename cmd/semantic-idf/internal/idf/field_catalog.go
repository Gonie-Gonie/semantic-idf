...
var objectFieldCatalog = map[string]ObjectSpec{
	...
	"construction": catalogObject("Construction",
		field("Name", fieldRoleName),
		extensibleField("Outside Layer", fieldRoleObjectRef, "layers", 1),
	),
	"construction:internalsource": catalogObject("Construction:InternalSource",
		field("Name", fieldRoleName),
		numericField("Source Present After Layer Number", false),
		numericField("Temperature Calculation Requested After Layer Number", false),
		numericField("Dimensions for the CTF Calculation", false),
		numericUnitField("Tube Spacing", "m", false),
		numericUnitField("Two Dimensional Temperature Calculation Position", "m", false),
		extensibleField("Outside Layer", fieldRoleObjectRef, "layers", 1),
	),
	"construction:cfactorundergroundwall": catalogObject("Construction:CfactorUndergroundWall",
		field("Name", fieldRoleName),
		numericUnitField("C-Factor", "W/m2-K", false),
		numericUnitField("Height", "m", false),
	),
	"construction:ffactorgroundfloor": catalogObject("Construction:FfactorGroundFloor",
		field("Name", fieldRoleName),
		numericUnitField("F-Factor", "W/m-K", false),
		numericUnitField("Area", "m2", false),
		numericUnitField("Perimeter Exposed", "m", false),
	),
	"construction:airboundary": catalogObject("Construction:AirBoundary",
		field("Name", fieldRoleName),
		choiceField("Air Exchange Method", "", "None", "SimpleMixing", "AirflowNetwork"),
		numericField("Simple Mixing Air Changes per Hour", false),
		targetField("Simple Mixing Schedule Name", fieldRoleScheduleRef, "schedule", "schedules", "uses"),
	),
	"zonemixing": catalogObject("ZoneMixing",
		field("Name", fieldRoleName),
		...
		numericUnitField("Air Changes per Hour", "1/hr", false),
		field("Source Zone or Space Name", fieldRoleZoneRef),
	),
	"zonecrossmixing": catalogObject("ZoneCrossMixing",
		field("Name", fieldRoleName),
		field("Zone or Space Name", fieldRoleZoneRef),
		field("Schedule Name", fieldRoleScheduleRef),
		field("Design Flow Rate Calculation Method", ""),
	...
	"zonerefrigerationdoormixing": catalogObject("ZoneRefrigerationDoorMixing",
		field("Name", fieldRoleName),
		field("Zone 1 Name", fieldRoleZoneRef),
		field("Zone 2 Name", fieldRoleZoneRef),
		field("Schedule Name", fieldRoleScheduleRef),
		numericUnitField("Door Height", "m", false),
		numericUnitField("Door Area", "m2", false),
	...
	"airflownetwork:multizone:surface": catalogObject("AirflowNetwork:MultiZone:Surface",
		field("Surface Name", fieldRoleObjectRef),
		field("Leakage Component Name", fieldRoleObjectRef),
		field("External Node Name", fieldRoleObjectRef),
	),
	"material": catalogObject("Material",
		field("Name", fieldRoleName),
		field("Roughness", ""),
		numericUnitField("Thickness", "m", false),
		numericUnitField("Conductivity", "W/m-K", false),
		numericUnitField("Density", "kg/m3", false),
		numericUnitField("Specific Heat", "J/kg-K", false),
	),
	"material:nomass": catalogObject("Material:NoMass",
		field("Name", fieldRoleName),
		field("Roughness", ""),
		numericUnitField("Thermal Resistance", "m2-K/W", false),
	),
	"material:airgap": catalogObject("Material:AirGap",
		field("Name", fieldRoleName),
		numericUnitField("Thermal Resistance", "m2-K/W", false),
	),
	"windowmaterial:simpleglazingsystem": catalogObject("WindowMaterial:SimpleGlazingSystem",
		field("Name", fieldRoleName),
		numericUnitField("U-Factor", "W/m2-K", false),
		numericField("Solar Heat Gain Coefficient", false),
		numericField("Visible Transmittance", false),
	),
	...
	"airloophvac:unitary:furnace:heatonly": catalogObject("AirLoopHVAC:Unitary:Furnace:HeatOnly",
		field("Name", fieldRoleName),
		field("Availability Schedule Name", fieldRoleScheduleRef),
		field("Furnace Air Inlet Node Name", fieldRoleNodeRef),
		field("Furnace Air Outlet Node Name", fieldRoleNodeRef),
		field("Supply Air Fan Operating Mode Schedule Name", fieldRoleScheduleRef),
		numericUnitField("Maximum Supply Air Temperature", "C", true),
		numericUnitField("Heating Supply Air Flow Rate", "m3/s", true),
		field("Controlling Zone or Thermostat Location", fieldRoleZoneRef),
		field("Supply Fan Object Type", fieldRoleObjectTypeRef),
		field("Supply Fan Name", fieldRoleObjectRef),
