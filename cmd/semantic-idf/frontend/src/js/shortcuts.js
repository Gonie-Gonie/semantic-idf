...
function shortcutAction(id, actions) {
  const map = {
    ...
    tabMetrics: () => actions.switchResultTab?.("metrics"),
    ...
    tabTopology: () => actions.switchResultTab?.("topology"),
    topology3D: () => actions.setTopologyMode?.("3d"),
    topologyPlan: () => actions.setTopologyMode?.("plan"),
    topologyNetwork: () => actions.setTopologyMode?.("thermal"),
    topologyFit: actions.fitTopology,
